...
export function StickyNavbar() {
    ...
    const navList = (
        <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 *:work-sans">
            <Typography
                as="li"
                variant="small"
                color="blue-gray"
            ...
            <Navbar className="z-10 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4">
                <div className="flex items-center justify-between text-blue-gray-900">
                    <Typography
                        as="a"
                        href="#"
                        className="mr-4 cursor-pointer py-1.5 font-black text-2xl work-sans"
                    >
                        The Reading Room
                    </Typography>
